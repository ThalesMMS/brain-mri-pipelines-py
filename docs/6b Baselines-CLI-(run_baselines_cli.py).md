...
For deep learning model training, see [Deep Models CLI](7c%20License-&-Usage-Terms.md). For the graphical interface, see [Graphical User Interface](7a%20Git-Configuration.md). For detailed baseline model architectures and theoretical background, see [Classical Machine Learning Baselines](5c%20Stage-3-RL-Hyperparameter-Refinement-%28run_pc3_rl_refinement.py%29.md).
 ...
 **Sources**: [Project overview and setup](https://github.com/ThalesMMS/brain-mri-pipelines-py/blob/cd9d51a5/README.md#L161-L169)
...
These features are extracted through semi-automatic segmentation available in the GUI (see [Graphical User Interface](7a%20Git-Configuration.md)).
...
For deep learning training workflows, see [Deep Models CLI](7c%20License-&-Usage-Terms.md).
